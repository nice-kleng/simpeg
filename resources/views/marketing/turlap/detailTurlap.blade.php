...
<a href="javascript:void(0)" data-toggle="modal" data-target="#turlapModal"
    class="btn btn-primary btn-sm pull-right">Input Turlap</a>
@endsection
        ...
        $('#turlap-table').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#turlapForm').attr('action', "{{ route('turlap.update', ':id') }}".replace(':id', id));
                }
            });
        });
