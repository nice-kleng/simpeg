...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="x_panel">
                <div class="x_title">
                    <a href="{{ route('brand.unduhTemplateImport', $sumberMarketing->id) }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)"
                                                data-url="{{ route('brand.destroy', $marketing->id) }}"
                                                onclick="deleteData(this)"
                                                class="btn btn-danger btn-sm btn-delete">Hapus</a>
                                            <a href="{{ route('brand.followUp', $marketing->id) }}"
            ...
            $('#brand-table').on('click', '.btn-edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#brandForm').attr('action', "{{ route('brand.update', ':id') }}"
                            .replace(':id', id));
                    }
                });
            });
