                        ...
                        <tbody>
                            @foreach ($sumberMarketings as $sumberMarketing)
                                <tr>
                                    ...
                                    <td><a href="{{ route('brand.detailBrandByArea', $sumberMarketing->id) }}"><span class="badge badge-{{ ['primary', 'success', 'info', 'warning', 'danger'][$loop->index % 5] }}">{{ $sumberMarketing->nama_sumber_marketing }}</span></a></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" data-url="{{ route('brand.destroy', $sumberMarketing->id) }}" onclick="deleteData(this)" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
