...
<a href="javascript:void(0)" data-toggle="modal" data-target="#leadsModal"
    class="btn btn-primary btn-sm pull-right">Input Leads</a>
@endsection
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" data-url="{{ route('leads.destroy', $marketing->id) }}"
                                        onclick="deleteData(this)" class="btn btn-danger btn-sm btn-delete">Hapus</a>
                                    <a href="{{ route('leads.followUp', $marketing->id) }}" class="btn btn-info btn-sm btn-followup">Follow Up</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
        ...
        $('#leads-table').on('click', '.btn-edit', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#leadsForm').attr('action', "{{ route('leads.update', ':id') }}".replace(':id', id));
                }
            });
        });
