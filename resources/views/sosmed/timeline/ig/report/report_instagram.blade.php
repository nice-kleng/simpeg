@extends('layouts.app', ['pageTitle' => 'Report Timeline Instagram'])
...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Report Timeline Instagram</h2>
                <a href="{{ route('timelineInstagram.index') }}" class="btn btn-secondary pull-right">Kembali</a>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <form id="report-form" action="{{ route('timelineInstagram.storeReport') }}" method="POST">
                    @csrf
                    <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div id="step-1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jangkauan" name="jangkauan" value="{{ old('jangkauan') }}">
                            </div>
                            <div class="form-group">
                                <label for="interaksi">Interaksi</label>
                                <input type="text" class="form-control" id="interaksi" name="interaksi" value="{{ old('interaksi') }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div id="step-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="impresi" name="impresi" value="{{ old('impresi') }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div id="step-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="pengikut" name="pengikut" value="{{ old('pengikut') }}">
                            </div>
                            <div class="form-group">
                                <label for="bukan_pengikut">Bukan Pengikut</label>
                                <input type="number" class="form-control" id="bukan_pengikut" name="bukan_pengikut" value="{{ old('bukan_pengikut') }}">
                            </div>
                            {{-- <div class="form-group">
                        ...
                        <div id="step-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profile" name="profile" value="{{ old('profile') }}">
                            </div>
                            <div class="form-group">
                                <label for="beranda">Beranda</label>
                                <input type="text" class="form-control" id="beranda" name="beranda" value="{{ old('beranda') }}">
                            </div>
                            <div class="form-group">
                                <label for="jelajahi">Jelajahi</label>
                                <input type="text" class="form-control" id="jelajahi" name="jelajahi" value="{{ old('jelajahi') }}">
                            </div>
                            <div class="form-group">
                                <label for="lainnya">Lainnya</label>
                                <input type="text" class="form-control" id="lainnya" name="lainnya" value="{{ old('lainnya') }}">
                            </div>
                            <div class="form-group">
                                <label for="tagar">Tagar</label>
                                <input type="text" class="form-control" id="tagar" name="tagar" value="{{ old('tagar') }}">
                            </div>
                        </div>
                        ...
                        <div id="step-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jumlah_pemutaran" name="jumlah_pemutaran" value="{{ old('jumlah_pemutaran') }}">
                            </div>
                            <div class="form-group">
                                <label for="waktu_tonton">Waktu Tonton</label>
                                <input type="text" class="form-control" id="waktu_tonton" name="waktu_tonton" value="{{ old('waktu_tonton') }}">
                            </div>
                            <div class="form-group">
                                <label for="rata">Rata-rata</label>
                                <input type="text" class="form-control" id="rata" name="rata" value="{{ old('rata') }}">
                            </div>
                            <div class="form-group">
